...
# Database: hqsen_test
# Generation Time: 2017-07-15 09:36:19 +0000
# ************************************************************
...
CREATE TABLE `hqsen_hotel_data` (
  ...
  `hotel_image` varchar(1024) NOT NULL DEFAULT '' COMMENT '酒店介绍图片',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `hqsen_hotel_room` (
  ...
  `room_image` varchar(1024) NOT NULL DEFAULT '' COMMENT '宴会厅介绍图片',
  `hotel_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '酒店ID',
