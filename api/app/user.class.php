...
//                }
    ...
    public function mainList(){
        ...
        if($list_type == 1){
            ...
            $hotel = $this->db->getRows("select * from hqsen_hotel as hh left join hqsen_hotel_data as hhd on hh.id = hhd.id where  hh.is_data = 1 and  hh.area_sh_id = $area_sh_id and hh.del_flag = 1   and  hhr.del_flag = 1  order by hh.weight asc ");
        }
        $data = [];
        if($hotel){
